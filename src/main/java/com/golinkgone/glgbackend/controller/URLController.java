...
public class URLController {
    ...
    public ResponseEntity<Page<LinkItemResponse>> getMyLinks(
        ...
        Page<LinkItemResponse> links =
                urlShortenerService.getUserLinks(UUID.fromString(jwt.getSubject()), page, Math.min(size, 100));
    ...
    public ResponseEntity<DashboardResponse> getDashboard(
        ...
        UUID linkId = ownerService
                .resolveOwnedLinkId(shortKey, UUID.fromString(jwt.getSubject()))
